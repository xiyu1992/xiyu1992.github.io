//copyright by cdll  cd234350150@gmail.com
var dbVersion= '1.0.0';
var cdDB=function(dbname){
    var db=openDatabase(dbname,dbVersion,'',65536);
    return{
        //返回数据库名
        getDBName:function(){
            return dbname;
...
db.switchTable('channel_list').insertData(
    [{name:'aa',link:'ss',
     ...
     {name:'bb',link:'kk',updatetime:new Date().getTime()}
    ]
);
db.where({id:'2'}).getData(function(result){
